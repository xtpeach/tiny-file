package com.xtpeach.tiny.file.server.module.storage.controller.callback;
...
public class GoogleDriveCallbackController {
	...
	@Value("${zfile.gd.clientId:659016983345-vlp413rgrl2spe5d53ml16p2btslfa44.apps.googleusercontent.com}")
	private String clientId;
	
	@Value("${zfile.gd.redirectUri:http://localhost:8080/gd/callback}")
	private String redirectUri;
	
	@Value("${zfile.gd.clientSecret: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}")
	private String clientSecret;
	
	@Value("${zfile.gd.scope:https://www.googleapis.com/auth/drive}")
