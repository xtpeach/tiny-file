package com.xtpeach.tiny.file.server.module.link.aspect;
...
import com.xtpeach.tiny.file.server.module.link.model.enums.RefererTypeEnum;
...
public class RefererCheckAspect {
	 ...
	 * @return  方法运行结果
	 */
	@Around(value = "@annotation(com.xtpeach.tiny.file.server.module.storage.annotation.RefererCheck)")
